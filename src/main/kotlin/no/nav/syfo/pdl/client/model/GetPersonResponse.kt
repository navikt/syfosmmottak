...
data class ResponseData(val hentIdenterBolk: List<HentIdenterBolk>?)

data class HentIdenterBolk(val ident: String, val identer: List<PdlIdent>?, val code: String)

data class PdlIdent(val ident: String, val historisk: Boolean, val gruppe: String)
