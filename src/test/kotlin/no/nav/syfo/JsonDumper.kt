...
fun main() {
    ...
    println(objectMapper.writeValueAsString(sm.toSykmelding("detteerensykmeldingid", "41234123", "12890371", "123124334", LocalDateTime.now(), "1213415151", "1213415151")))
    ...
    val receivedSykmelding = ReceivedSykmelding(
        sykmelding = sm.toSykmelding("detteerensykmeldingid", "41234123", "12890371", "123124334", LocalDateTime.now(), "1213415151", "1213415151"),
