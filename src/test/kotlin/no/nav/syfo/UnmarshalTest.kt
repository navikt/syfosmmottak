...
internal class UnmarshalTest {
    ...
    internal fun `Test unmarshal dates testsett 2`() {
        val healthInformation =
            fellesformatUnmarshaller.unmarshal(
                StringReader(getFileAsString("src/test/resources/helseopplysninger-UTF-8.xml"))
            ) as HelseOpplysningerArbeidsuforhet
    ...
    internal fun `Test unmarshal dates testsett 3`() {
        val healthInformation =
            fellesformatUnmarshaller.unmarshal(
                StringReader(getFileAsString("src/test/resources/generated_sm_2.xml"))
            ) as HelseOpplysningerArbeidsuforhet
    ...
    internal fun `Test unmarshal dates testsett 4`() {
        val healthInformation =
            fellesformatUnmarshaller.unmarshal(
                StringReader(getFileAsString("src/test/resources/generated_sm_3.xml"))
            ) as HelseOpplysningerArbeidsuforhet
    ...
    internal fun `Test unmarshal dates testsett 5`() {
        val healthInformation =
            fellesformatUnmarshaller.unmarshal(
                StringReader(getFileAsString("src/test/resources/generated_sm_4.xml"))
            ) as HelseOpplysningerArbeidsuforhet
